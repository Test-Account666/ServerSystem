...
public final class FileUtils {
    ...
    public static void deleteDirectory(File file) throws IOException {
        ...
        for (var listedFile : file.listFiles())
            if (listedFile.isDirectory()) FileUtils.deleteDirectory(listedFile);
            else FileUtils.deleteFile(listedFile);
    ...
    public static void copyDirectory(File source, File destination) throws IOException {
        ...
        if (source.getCanonicalPath().equals(destination.getCanonicalPath())) throw new IOException("Destination and source are the same!");
        ...
        for (var file : source.listFiles())
            ...
            else FileUtils.copyFile(file, new File(destination, file.getName()));
    }
