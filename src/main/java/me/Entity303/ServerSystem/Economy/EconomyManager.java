...
public class EconomyManager extends ManagerEconomy {
    ...
    public EconomyManager(String currencySingular, String currencyPlural, String startingMoney, String displayFormat, String moneyFormat, String separator, String thousand, ss plugin) {
