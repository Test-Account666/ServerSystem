...
public class VanishPacket_Reflection_To_1_16 extends VanishPacket {
    ...
    public VanishPacket_Reflection_To_1_16(me.Entity303.ServerSystem.Main.ss plugin) {
        this.plugin = plugin;
        try {
    ...
    public void setVanish(Player player, boolean vanish) {
        ...
        if (this.collidesWithEntitiesField != null) try {
        ...
        if (this.getProfileMethod == null) try {
            this.getProfileMethod = Class.forName("net.minecraft.server." + this.getVersion() + ".EntityHuman").getMethod("getProfile");
        } catch (NoSuchMethodException | ClassNotFoundException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            playerInfo = cons.newInstance(Class.forName("net.minecraft.server." + this.getVersion() + ".PacketPlayOutPlayerInfo$EnumPlayerInfoAction").getEnumConstants()[0], players);
        ...
        if (this.constructor == null) {
            ...
            Class<?> clazz = null;
            try {
                clazz = this.getClass().getClassLoader().loadClass("net.minecraft.server." + this.getVersion() + ".PacketPlayOutPlayerInfo$PlayerInfoData");
            ...
            try {
                this.constructor = clazz
                        .getDeclaredConstructor(Class.forName("net.minecraft.server." + this.getVersion() + ".PacketPlayOutPlayerInfo"),
                                ...
                                int
                                        .class,
                                Class.forName("net.minecraft.server." + this.getVersion() + ".EnumGamemode"),
        ...
        try {
            playerInfoData = this.constructor
                    .newInstance(playerInfo,
                            this.getProfileMethod.invoke(entityPlayer),
                            this.getPing(player),
                            Class.forName("net.minecraft.server." + this.getVersion() + ".EnumGamemode").getEnumConstants()[4],
