...
public class VirtualSmithing_Latest extends VirtualSmithing {
    ...
    public void openSmithing(Player player) {
        ...
        ContainerSmithing container = null;
        try {
        ...
        container.setTitle(IChatBaseComponent.ChatSerializer.a("{\"text\":\"Smithing\"}"));
        ...
        try {
            ...
            Virtual.sendPacketMethod.invoke(playerConnection, new PacketPlayOutOpenWindow(id, Containers.r, IChatBaseComponent.ChatSerializer.a("{\"text\":\"Smithing\"}")));
        } catch (IllegalAccessException | InvocationTargetException e) {
            e.printStackTrace();
            return;
        }
