...
public class InteractListener implements Listener {
    ...
    public void OnInventoryClose(InventoryCloseEvent event) {
        ...
        boolean allowFlying;
        boolean flying;
        if (!this._open.contains(event.getPlayer())) return;
        ...
        Bukkit.getScheduler().runTaskLater(Bukkit.getPluginManager().getPlugin("ServerSystem"), () -> {
            ...
            if (flying) ((Player) event.getPlayer()).setFlying(true);
        }, 1L);
    ...
    public void OnInteract(PlayerInteractEvent event) {
        if (this._plugin.GetVanish() == null) return;
        ...
        Bukkit.getScheduler().runTaskLater(Bukkit.getPluginManager().getPlugin("ServerSystem"), () -> {
            ...
            if (flying) event.getPlayer().setFlying(true);
        }, 1L);
    }
    ...
    private boolean IsShulker(Material type) {
        return type == Material.getMaterial("SHULKER_BOX") || type == Material.getMaterial("BLACK_SHULKER_BOX") || type == Material.getMaterial("BLUE_SHULKER_BOX") ||
               type == Material.getMaterial("BROWN_SHULKER_BOX") || type == Material.getMaterial("CYAN_SHULKER_BOX") ||
               type == Material.getMaterial("GRAY_SHULKER_BOX") || type == Material.getMaterial("GREEN_SHULKER_BOX") ||
               type == Material.getMaterial("LIGHT_BLUE_SHULKER_BOX") || type == Material.getMaterial("LIGHT_GRAY_SHULKER_BOX") ||
               type == Material.getMaterial("LIME_SHULKER_BOX") || type == Material.getMaterial("MAGENTA_SHULKER_BOX") ||
               type == Material.getMaterial("ORANGE_SHULKER_BOX") || type == Material.getMaterial("PINK_SHULKER_BOX") ||
               type == Material.getMaterial("PURPLE_SHULKER_BOX") || type == Material.getMaterial("RED_SHULKER_BOX") ||
               type == Material.getMaterial("WHITE_SHULKER_BOX") || type == Material.getMaterial("YELLOW_SHULKER_BOX");
    }
