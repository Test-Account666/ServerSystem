...
import me.entity303.serversystem.silentinventory.EnumDirectionList_v1_10_R1;
import me.entity303.serversystem.silentinventory.SilentInventory_v1_10_R1;
...
public class InteractListener_v1_10_R1 implements Listener {
    private final ServerSystem plugin;

    public InteractListener_v1_10_R1(ServerSystem plugin) {
        this.plugin = plugin;
    }
    ...
    private void activateChest(Player p, int x, int y, int z) {
        ...
        for (net.minecraft.server.v1_10_R1.EnumDirection direction : EnumDirectionList_v1_10_R1.HORIZONTAL) {
        ...
        ITileInventory baum = new SilentInventory_v1_10_R1(tileInventory);
