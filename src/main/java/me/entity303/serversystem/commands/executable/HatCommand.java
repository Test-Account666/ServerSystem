...
public class HatCommand implements ICommandExecutorOverload {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String commandLabel, String[] arguments) {
        ...
        if (player.getInventory().getItemInMainHand().getType() != Material.AIR) {
            ...
            commandSender.sendMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages()
                                                                                           .GetMessage(commandLabel, command, commandSender, null, "Hat.Success.NewHat")
        ...
        commandSender.sendMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages()
                                                                                       .GetMessage(commandLabel, command, commandSender, null, "Hat.Success.HatRemoved")
                                                                                       .replace("<TYPE>", player.getInventory().getHelmet().getType().toString()));
