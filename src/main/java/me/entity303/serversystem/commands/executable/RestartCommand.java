...
@ServerSystemCommand(name = "Restart")
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String commandLabel, String[] arguments) {
        ...
        if (this._restarting) {
            ...
            commandSender.sendMessage(
                    this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages().GetMessage(label1, command1, commandSender, null, "Restart.AlreadyRestarting"));
            return true;
        }
            ...
            Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                ...
                Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                    ...
                    Bukkit.broadcastMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages()
                                                                                                 .GetMessage(label9, command9, commandSender, null,
                    ...
                    Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                        ...
                        Bukkit.broadcastMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages()
                                                                                                     .GetMessage(label8, command8, commandSender, null,
                                                                                                                 "Restart.RestartTimer")
                                                                                                     .replace("<TIME>", sek[0]));
                        sek[0] = "5";
                        Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                                ...
                                Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                                    ...
                                    Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                                        ...
                                        Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                                            ...
                                            Bukkit.broadcastMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages()
                                                                                                                         .GetMessage(label3, command3, commandSender,
                                                                                                                                     null, "Restart" + ".RestartTimer")
                                                                                                                         .replace("<TIME>", sek[0]));
                                            sek[0] = "0";
                                            Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                                                ...
                                                Bukkit.broadcastMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages()
                                                                                                                             .GetMessage(label2, command2, commandSender,
                                                                                                                                         null,
                                                                                                                                         "Restart" + ".RestartTimer")
                                                                                                                             .replace("<TIME>", sek[0]));
                                                sek[0] = "10";
                                                Bukkit.getScheduler().runTaskLater(this._plugin, () -> {
                                                    ...
                                                    Bukkit.broadcastMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages()
                                                                                                                                 .GetMessage(label1, command1,
                                                                                                                                             ...
                                                                                                                                             ".RestartMessage")
                                                                                                                                 .replace("<TIME>", "0"));
                                                    Bukkit.getScheduler().runTaskLater(this._plugin, () -> Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "stop"), 20);
                                                }, 20);
                                            }, 20);
                                        }, 20);
                                    }, 20);
