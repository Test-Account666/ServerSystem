...
@ServerSystemCommand(name = "Teleport")
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String commandLabel, String[] arguments) {
        if (arguments.length == 0) {
            if (!this._plugin.GetPermissions().HasPermission(commandSender, "tp.self", true)) {
                if (!this._plugin.GetPermissions().HasPermission(commandSender, "tp.others", true)) {
                    this._plugin.Info(
                            ChatColor.TranslateAlternateColorCodes('&', this._plugin.GetMessages().GetConfiguration().GetString("Messages.Misc.NoPermissionInfo"))
                    ...
                    commandSender.sendMessage(this._plugin.GetMessages().GetPrefix() +
                                              this._plugin.GetMessages().GetNoPermission(selfTeleportPermission + " || " + othersTeleportPermission));
                    return true;
                }
            }

            commandSender.sendMessage(this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages().GetSyntax(commandLabel, command, commandSender, null, "Tp"));
            return true;
        }
        ...
        if (arguments.length == 1) {
            if ((!(commandSender instanceof Player))) {
                ...
                commandSender.sendMessage(
                        this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages().GetSyntax(commandLabel, command, commandSender, null, "Tp"));
                return true;
            }
            ...
            if (target != commandSender) {
                if (!this._plugin.GetWantsTeleport().DoesPlayerWantTeleport(target)) {
                    ...
                    commandSender.sendMessage(this._plugin.GetMessages().GetPrefix() +
                                              this._plugin.GetMessages().GetMessage(commandLabel, command, commandSender, target, "Tp.NoTeleportations"));
                    return true;
                }
            }
            ...
            commandSender.sendMessage(
                    this._plugin.GetMessages().GetPrefix() + this._plugin.GetMessages().GetMessage(commandLabel, command, commandSender, target, "Tp.Self"));
            return true;
        }
        ...
        if (target1 != commandSender) {
            if (!this._plugin.GetWantsTeleport().DoesPlayerWantTeleport(target1)) {
                ...
                commandSender.sendMessage(this._plugin.GetMessages().GetPrefix() +
                                          this._plugin.GetMessages().GetMessage(commandLabel, command, commandSender, target1, "Tp.NoTeleportations"));
                return true;
            }
        }
        ...
        if (target2 != commandSender) {
            if (!this._plugin.GetWantsTeleport().DoesPlayerWantTeleport(target2)) {
                ...
                commandSender.sendMessage(this._plugin.GetMessages().GetPrefix() +
                                          this._plugin.GetMessages().GetMessage(commandLabel, command, commandSender, target2, "Tp.NoTeleportations"));
                return true;
            }
        }
