...
public class AsyncUnmuteEvent extends Event {
    ...
    public AsyncUnmuteEvent(CommandSender sender, OfflinePlayer target) {
        this(sender, target, ServerSystem.getPlugin(ServerSystem.class).getMessages().getMessageWithStringTarget("unmute", "unmute", sender, target.getName(), "Mute.DefaultReason"));
    }
